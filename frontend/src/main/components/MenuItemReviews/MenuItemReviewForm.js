                ...
                <Col>
                    <Form.Group className="mb-3" >
                        ...
                        <Form.Control.Feedback type="invalid">
                            ...
                            {errors.reviewerEmail?.type === 'pattern' && 'ReviewerEmail must be in the format cgaucho@ucsb.edu i.e *@*.*'}
                        </Form.Control.Feedback>
                    </Form.Group>
                </Col>
                ...
                <Col>
                    <Form.Group className="mb-3" >
                        ...
                        <Form.Control.Feedback type="invalid">
                            ...
                            {errors.dateReviewed?.type === 'pattern' && 'DateReviewed must be in the format of ISO'}
                        </Form.Control.Feedback>
                    </Form.Group>
                </Col>
            </Row>
