...
describe("HelpRequestCreatePage tests", () => {
    ...
    test("when you fill in the form and hit submit, it makes a request to the backend", async () => {
        ...
        fireEvent.change(requestTimeField, { target: { value: '2023-11-10T00:00:00' } });
        ...
        expect(mockToast).toBeCalledWith("New helpRequest Created - id: 17 requesterEmail: bradencastillo@ucsb.edu");
